...
%    \appendixwithtoc
    ...
    \begin{figure}[p]
        \centering
        \includegraphics[width=\linewidth]{../3_figures/prior_pe.pdf}
        \caption{}
    \end{figure}
    
    \begin{figure}[p]
        \centering
        \includegraphics[width=\linewidth]{../3_figures/prior_trans_times.pdf}
        \caption{}
    \end{figure}
    
    \begin{figure}[p]
        \centering
        \includegraphics[width=\linewidth]{../3_figures/prior_trajectories.pdf}
        \caption{}
    \end{figure}
    
    \begin{figure}[p]
        \centering
        \includegraphics[width=\linewidth]{../3_figures/trace_plots.pdf}
        \caption{}
    \end{figure}
    ...
    \begin{landscape}
        \begin{figure}[p]
            \centering
            \includegraphics[width=\linewidth]{../3_figures/ataccc_fit.pdf}
            \caption{}
        \end{figure}
        
        \begin{figure}[p]
            \centering
            \includegraphics[width=\linewidth]{../3_figures/nba_fit.pdf}
            \caption{}
        \end{figure}
    
        \begin{figure}[p]
            \centering
            \includegraphics[width=\linewidth]{../3_figures/uiuc_fit.pdf}
            \caption{}
        \end{figure}
    
        \begin{figure}[p]
            \centering
            \includegraphics[width=\linewidth]{../3_figures/hic_fit.pdf}
            \caption{}
        \end{figure}
    \end{landscape}
